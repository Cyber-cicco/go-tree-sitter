...
[![Build Status](https://github.com/Cyber-cicco/go-tree-sitter/workflows/Test/badge.svg?branch=master)](https://github.com/Cyber-cicco/go-tree-sitter/actions/workflows/test.yml?query=branch%3Amaster)
[![GoDoc](https://godoc.org/github.com/Cyber-cicco/go-tree-sitter?status.svg)](https://godoc.org/github.com/Cyber-cicco/go-tree-sitter)
...
import (
	...
	"github.com/Cyber-cicco/go-tree-sitter/javascript"
)
...
See explanation on how to create a grammar for go-tree-sitter [here](https://github.com/Cyber-cicco/go-tree-sitter/issues/57).
